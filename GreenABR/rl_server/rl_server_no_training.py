    ...
    class Request_Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            if ( 'pastThroughput' in post_data ):
                ...
                self.log_file.write('time:'+str(time.time()) + '||\t' +
                                    'lastquality:'+str(VIDEO_BIT_RATE[post_data['lastquality']]) + '||\t' +
                                    'buffer:'+str(post_data['buffer']) + '||\t' +
                                    'rebuffer(?):'+str(rebuffer_time / M_IN_K) + '||\t' +
                                    'video_chunk_size:'+str(video_chunk_size) + '||\t' +
                                    'video_chunk_fetch_time:'+str(video_chunk_fetch_time) + '||\t' +
                                    'reward:'+str(reward) + '||\n')
                self.log_file.flush()
